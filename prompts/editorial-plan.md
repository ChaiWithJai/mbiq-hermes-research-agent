...
- Queens connection already present in the calendar;
- a provisional community or audience, stated narrowly;
- the question worth researching;
- primary, community, and complicating source targets;
- likely story route if the evidence holds;
- timing and editorial value;
- risk of a generic NYC frame, cultural flattening, duplicate record, or unsupported date;
- decision: `advance`, `hold`, or `reject`, with a plain reason.
